...
test("quality validation rejects noisy fallback content", () => {
    const noisy = assessExtractionQuality("Sign in Home Shorts Subscriptions Recommended videos Accept cookies Privacy policy Watch full video", "body-fallback", "youtube");
...
test("deterministic description preserves a short summary and bullets", () => {
    const description = buildDeterministicDescription({
        ...
        cacheable: true,
        content: "First sentence explains the article. Second sentence adds context. Third sentence finishes the main idea cleanly.",
        metadata: {
            title: "An article",
...
//# sourceMappingURL=ingestion.test.js.map