 ...
 */
const chatRetrievalCache = new Map();
 ...
 */
export const aiTagController = async (req, res) => {
    try {
 ...
 */
export const aiReprocessController = async (req, res) => {
    try {
 ...
 */
export const aiInsightsController = async (req, res) => {
    const userId = req.userId;
    ...
    try {
        ...
        const updated = await BrainInsightModel.findOneAndUpdate({ userId }, {
            ...intelligence,
