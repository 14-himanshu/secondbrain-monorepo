...
const extractHashtags = (value) => Array.from(new Set((value.match(/#[a-z0-9_]+/gi) || []).map((tag) => tag.replace(/^#/, "").toLowerCase()))).slice(0, 8);
export const extractTwitterContent = async (target, _mode = "deep") => {
    try {
...
//# sourceMappingURL=twitter.extractor.js.map